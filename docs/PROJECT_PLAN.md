...
> **구현 현황 — 2026-08-19**
>
> 원래 계획의 기술 선택 일부는 변경되었습니다. 현재 구현은 FastAPI, React,
> OpenCV, InsightFace 및 CUDA/TensorRT ONNX Runtime을 사용합니다. 실시간 카메라,
> 얼굴 등록·목록·삭제, Liveness, 역할 기반 인증, private biometric storage,
> Edu Manager 학생·출석 연동은 구현되어 draft PR #25에서 검토 중입니다.
>
> 남은 핵심 작업은 Jetson 운영 환경에서 CUDA wheel을 설치한 통합 시험, 기존 얼굴의
> 학생/수강행 매핑, 운영 보안 승인 및 공개 Git 이력 사고 대응입니다. 이 상태 표기는
> 아래의 초기 주차 계획보다 우선합니다.
